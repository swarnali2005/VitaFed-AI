...
def train_client3(client_data, global_model, epochs=10, learning_rate=0.01):
    """Train model on client 3's local data"""
...
if __name__ == "__main__":
    ...
    print("\nTraining Client 3...")
    result = train_client3(client_data_list[2], global_model)
